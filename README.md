# Angular Boot Camp example: standalone-components
...
**[StackBlitz for standalone-components](https://stackblitz.io/github/AngularBootCamp/standalone-components)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/standalone-components.git
cd standalone-components
npm install
npm start
```
